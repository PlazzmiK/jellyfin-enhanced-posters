...
/// </summary>
public class EnhancedPostersRestoreTask : IScheduledTask, IConfigurableScheduledTask
{
    private readonly ILibraryManager _libraryManager;
    private readonly IProviderManager _providerManager;
    private readonly PosterBackupManager _backupManager;
    private readonly RenderStampTracker _stampTracker;
    private readonly ILogger<EnhancedPostersRestoreTask> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="EnhancedPostersRestoreTask"/> class.
    /// </summary>
    ...
    /// <inheritdoc />
    public string Key => "EnhancedPostersRestore";
