...
/// </summary>
public class EnhancedPostersUpdateTask : IScheduledTask, IConfigurableScheduledTask
{
    ...
    private readonly ILogger<EnhancedPostersUpdateTask> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="EnhancedPostersUpdateTask"/> class.
    /// </summary>
    ...
    public EnhancedPostersUpdateTask(
        ...
        ILogger<EnhancedPostersUpdateTask> logger)
    {
    ...
    /// <inheritdoc />
    public string Key => "EnhancedPostersUpdate";
    ...
    public async Task ExecuteAsync(IProgress<double> progress, CancellationToken cancellationToken)
    {
        ...
        if (items.Count == 0)
        {
            _logger.LogInformation("No movies or shows found for Enhanced Posters update");
            progress.Report(100);
            return;
        }
        ...
        _logger.LogInformation(
            "Enhanced Posters update completed: {UpdatedCount} updated, {SkippedCount} skipped (unchanged), {FailedCount} failed",
            updatedCount,
            skippedCount,
            failedCount);
    }
