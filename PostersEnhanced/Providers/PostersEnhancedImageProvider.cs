...
namespace PostersEnhanced.Providers;

/// <summary>
/// Provides clean poster images from btttr.cc when browsing remote images in Jellyfin.
/// </summary>
public class PostersEnhancedImageProvider : IRemoteImageProvider, IHasOrder
{
    private readonly IHttpClientFactory _httpClientFactory;

    /// <summary>
    /// Initializes a new instance of the <see cref="PostersEnhancedImageProvider"/> class.
    /// </summary>
    /// <param name="httpClientFactory">The HTTP client factory.</param>
    public PostersEnhancedImageProvider(IHttpClientFactory httpClientFactory)
    {
